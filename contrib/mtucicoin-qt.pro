...
SOURCES += src/activemasternode.cpp \
           ...
           src/darksend.cpp \
           src/mtucicoin-cli.cpp \
           src/mtucicoin-tx.cpp \
           src/mtucicoind.cpp \
           src/db.cpp \
           ...
           src/qt/mtucicoin.cpp \
           src/qt/mtucicoinstrings.cpp \
...
RESOURCES += src/qt/mtucicoin.qrc src/qt/mtucicoin_locale.qrc
TRANSLATIONS += src/qt/locale/mtucicoin_bg.ts \
                src/qt/locale/mtucicoin_de.ts \
                src/qt/locale/mtucicoin_en.ts \
                src/qt/locale/mtucicoin_es.ts \
                src/qt/locale/mtucicoin_fi.ts \
                src/qt/locale/mtucicoin_fr.ts \
                src/qt/locale/mtucicoin_it.ts \
                src/qt/locale/mtucicoin_ja.ts \
                src/qt/locale/mtucicoin_pl.ts \
                src/qt/locale/mtucicoin_pt.ts \
                src/qt/locale/mtucicoin_ru.ts \
                src/qt/locale/mtucicoin_sk.ts \
                src/qt/locale/mtucicoin_sv.ts \
                src/qt/locale/mtucicoin_vi.ts \
                src/qt/locale/mtucicoin_zh_CN.ts \
                src/qt/locale/mtucicoin_zh_TW.ts
