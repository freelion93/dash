...
Only requiring some minor changes is mtucicoin.cpp.
...
Changes to mtucicoin.cpp
----------------------
mtucicoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
