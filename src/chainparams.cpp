...
public:
    CMainParams() {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 24 * 60 * 60; // Mtucicoin: 1 day
        nTargetSpacing = 2.5 * 60; // Mtucicoin: 2.5 minutes
        ...
        vSeeds.push_back(CDNSSeedData("mtucicoin.io", "dnsseed.mtucicoin.io"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        /*vSeeds.push_back(CDNSSeedData("mtucicoin.io", "testnet-seed.mtucicoin.io"));
