...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Mtucicoin Core"),
     ...
     * override -datadir in the mtucicoin.conf file in the default data directory
     * (to be consistent with mtucicoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
