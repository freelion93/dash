    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Mtucicoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Mtucicoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and mtucicoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Mtucicoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Mtucicoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Mtucicoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Mtucicoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Mtucicoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a mtucicoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Mtucicoin Core help message to get a list with possible Mtucicoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Mtucicoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Mtucicoin network", "", count));
}
...
{
    QString strTitle = tr("Mtucicoin Core"); // default title
