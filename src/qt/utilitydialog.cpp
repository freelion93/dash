    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Mtucicoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Mtucicoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  mtucicoin-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Mtucicoin Core is shutting down...") + "<br /><br />" +
