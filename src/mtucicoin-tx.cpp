...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Mtucicoin Core mtucicoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  mtucicoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mtucicoin transaction") + "\n" +
              "  mtucicoin-tx [options] -create [commands]   " + _("Create hex-encoded mtucicoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded mtucicoin transaction
