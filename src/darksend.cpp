...
/* *** BEGIN DARKSEND MAGIC - MTUCICOIN **********
    Copyright (c) 2014-2015, Mtucicoin Developers
        eduffield - evan@mtucicoin.io
        udjinm6   - udjinm6@mtucicoin.io
*/
    ...
    if(fMasterNode) {
        ...
        BOOST_FOREACH(const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat Mtucicoin and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("mtucicoin-darksend");
